...
goog.require('cljs.reader');
taoensso.sente.interfaces.IPacker = (function (){var obj15420 = {};return obj15420;
})();
taoensso.sente.interfaces.pack = (function pack(_,x){if((function (){var and__3612__auto__ = _;if(and__3612__auto__)
...
{var x__4260__auto__ = (((_ == null))?null:_);return (function (){var or__3624__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__4260__auto__)]);if(or__3624__auto__)
{return or__3624__auto__;
} else
{var or__3624__auto____$1 = (taoensso.sente.interfaces.pack["_"]);if(or__3624__auto____$1)
...
taoensso.sente.interfaces.unpack = (function unpack(_,x){if((function (){var and__3612__auto__ = _;if(and__3612__auto__)
...
{var x__4260__auto__ = (((_ == null))?null:_);return (function (){var or__3624__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__4260__auto__)]);if(or__3624__auto__)
{return or__3624__auto__;
} else
{var or__3624__auto____$1 = (taoensso.sente.interfaces.unpack["_"]);if(or__3624__auto____$1)
{return or__3624__auto____$1;
} else
...
taoensso.sente.interfaces.EdnPacker.cljs$lang$ctorPrWriter = (function (this__4200__auto__,writer__4201__auto__,opt__4202__auto__){return cljs.core._write.call(null,writer__4201__auto__,"taoensso.sente.interfaces/EdnPacker");
});
...
{if((function (){var G__15422 = x;if(G__15422)
...
{return G__15422.taoensso$sente$interfaces$IPacker$;
}
})()))
{return true;
} else
{if((!G__15422.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__15422);
} else
{return false;
}
}
