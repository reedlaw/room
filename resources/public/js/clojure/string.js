...
{var pred__10567 = cljs.core._EQ_;var expr__10568 = limit;if(cljs.core.truth_(pred__10567.call(null,(1),expr__10568)))
...
var G__10570 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10571 = (limit__$1 - (1));
var G__10572 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10570;
limit__$1 = G__10571;
parts = G__10572;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10574 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10574))
{var replacement_10575 = temp__4124__auto___10574;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10575)));
} else
{buffer.append(ch);
}
{
var G__10576 = (index + (1));
index = G__10576;
continue;
}
}
