...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16055 = (0);while(true){
var m_16056 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16056 == null))
{} else
{m_16056.call(null);
if((count_16055 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16057 = (count_16055 + (1));
count_16055 = G__16057;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3452__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3452__auto__)
