...
{return (function() { 
var G__10630__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3464__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3464__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__10633 = res;(G__10633[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__10633;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__10634){var vec__10636 = p__10634;var id = cljs.core.nth.call(null,vec__10636,(0),null);var class$ = cljs.core.nth.call(null,vec__10636,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_10637 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_10637 === "key")))
{(o[pname_10637] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__10640 = jsprops;(G__10640["defaultValue"] = value);
(G__10640["value"] = null);
(G__10640["onChange"] = ((function (G__10640,on_change,value){
return (function (p1__10638_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10638_SHARP_);
});})(G__10640,on_change,value))
);
return G__10640;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__10646 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__10646,(0),null);var id = cljs.core.nth.call(null,vec__10646,(1),null);var class$ = cljs.core.nth.call(null,vec__10646,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3464__auto__ = id;if(cljs.core.truth_(or__3464__auto__))
{return or__3464__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__10648 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__10648,(0),null);var id_class = cljs.core.nth.call(null,vec__10648,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj10652 = {};(obj10652[reagent.impl.util.cljs_argv] = v);
(obj10652[reagent.impl.util.cljs_level] = level);
return obj10652;
})();var k_10653 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__10654 = (((k_10653 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_10653);if((k_SINGLEQUOTE__10654 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__10654);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4333__auto___10655 = a.length;var i_10656 = (0);while(true){
if((i_10656 < n__4333__auto___10655))
{(a[i_10656] = reagent.impl.template.as_component.call(null,(a[i_10656]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4333__auto___10658 = a.length;var i_10659 = (0);while(true){
if((i_10659 < n__4333__auto___10658))
{if((i_10659 >= first_child))
{(a[i_10659] = reagent.impl.template.as_component.call(null,(a[i_10659]),level));
} else
{}
{
var G__10660 = (i_10659 + (1));
i_10659 = G__10660;
continue;
}
} else
