...
{return (function() { 
var G__10529__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3624__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3624__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__10532 = res;(G__10532[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__10532;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__10533){var vec__10535 = p__10533;var id = cljs.core.nth.call(null,vec__10535,(0),null);var class$ = cljs.core.nth.call(null,vec__10535,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_10536 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_10536 === "key")))
{(o[pname_10536] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__10539 = jsprops;(G__10539["defaultValue"] = value);
(G__10539["value"] = null);
(G__10539["onChange"] = ((function (G__10539,on_change,value){
return (function (p1__10537_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10537_SHARP_);
});})(G__10539,on_change,value))
);
return G__10539;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__10545 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__10545,(0),null);var id = cljs.core.nth.call(null,vec__10545,(1),null);var class$ = cljs.core.nth.call(null,vec__10545,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3624__auto__ = id;if(cljs.core.truth_(or__3624__auto__))
{return or__3624__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__10547 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__10547,(0),null);var id_class = cljs.core.nth.call(null,vec__10547,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj10551 = {};(obj10551[reagent.impl.util.cljs_argv] = v);
(obj10551[reagent.impl.util.cljs_level] = level);
return obj10551;
})();var k_10552 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__10553 = (((k_10552 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_10552);if((k_SINGLEQUOTE__10553 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__10553);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4493__auto___10554 = a.length;var i_10555 = (0);while(true){
if((i_10555 < n__4493__auto___10554))
{(a[i_10555] = reagent.impl.template.as_component.call(null,(a[i_10555]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4493__auto___10557 = a.length;var i_10558 = (0);while(true){
if((i_10558 < n__4493__auto___10557))
{if((i_10558 >= first_child))
{(a[i_10558] = reagent.impl.template.as_component.call(null,(a[i_10558]),level));
} else
{}
{
var G__10559 = (i_10558 + (1));
i_10558 = G__10559;
continue;
}
} else
